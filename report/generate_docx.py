...
def main():
    ...
    H2(doc, "4.11. Thử thách với câu hỏi diễn đạt tự nhiên và thẩm định ground-truth")
    ...
    H2(doc, "5.3. Hạn chế")
    bullet(doc, "Bộ câu hỏi đánh giá gồm 230 câu (50 soạn thủ công, 150 sinh từ tiêu đề Điều, 30 diễn đạt tự nhiên); kết quả trên nhóm câu tự nhiên thấp hơn rõ rệt (Mục 4.11) cho thấy khoảng cách từ vựng đời thường–pháp lý còn là thách thức. Phiếu thẩm định ground-truth đã lập nhưng cần chuyên gia pháp lý xác nhận chính thức.")
